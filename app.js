...
var cors = require("cors"); //дополнительные заголовки отдаваемые сервером(обход блокировок браузера)

var indexRouter = require('./routes/index');
var usersRouter = require('./routes/users');
var testAPIRouter = require("./routes/testAPI");
var transferDataRouter = require("./routes/transferData");
...
app.use('/transferData', transferDataRouter);
